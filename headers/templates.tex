...
\newcommand{\LaTeXShadedColorBoxTemplate}[2]{%
\begin{myshaded}{#1} % Pass argument 1 (e.g., color)
    #2               % Pass argument 2 (the content)
\end{myshaded}%
}
...
\newcommand{\Ja}[1]{\ding{51} {\bfseries Ja}}       % Standard pifont checkmark
% \newcommand{\Nein}[1]{\XSolidBrush {\bfseries Nein}}
\newcommand{\Nein}[1]{\ding{55} {\bfseries Nein}}   % Standard pifont X-cross
